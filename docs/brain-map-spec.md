...
>   one graph via single-corpus staging).
> - **`docs/brain-graphify-loops.md`** — the Journal / Map / Hands architecture and how the Map layer
>   relates to the rest of Brain OS.
>
> Kept as a stub so existing links don't dangle.
